        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('print.jabatan') }}" class="btn btn-success btn-md float-right ml-2" target="_blank">
                        Print Jabatan</a>
                    <a href="{{ route('grafik.jabatan') }}" class="btn btn-danger btn-md float-right ml-2">
                        Grafik
                        Jabatan</a>
                    <a href="{{ route('export.excel') }}" class="btn btn-info btn-md float-right ml-2">
                        Export Excel</a>
